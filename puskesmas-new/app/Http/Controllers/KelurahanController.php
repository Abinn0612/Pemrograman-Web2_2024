...
class KelurahanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin2/kelurahan')->with('pesan', 'Data Berhasil di Tambahkan');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('admin2/kelurahan')->with('pesan', 'Data Berhasil di Perbarui');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/admin2/kelurahan')->with('pesan', 'Data Berhasil di Hapus');
    }
}
